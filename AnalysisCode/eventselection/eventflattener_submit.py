...
frdir = '../fakerate/output_tzqtightid/fakeRateMaps' # put dummy path here if not using nonprompt from data
...
for year in years:
	...
	for region in regions:
		...
		outputfolder = '~/Files/tzqid/'+year+eventtype+'/'+region+'_'+stype+'_flat'
