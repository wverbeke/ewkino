...
if len(sys.argv) != 4:
    ...
    print('python eventflattener.py <input_directory> <output_directory> <event_selection>')
    sys.exit()
...
for inputfile in inputfiles:
    ...
    with open(script_name,'w') as script:
        ...
        script.write('cd {}\n'.format(cwd))
        command = './eventflattener {} {} {}'.format(inputfile,output_directory,event_selection)
