...
def makeconfigurationfile(filename,path_to_root_file,variables):
	...
	cfile.write('weight_branch = \'_weight\'\n\n')
	...
	cfile.write('validation_fraction = 0.4\n')
	...
	cfile.write('min_generations = 3\n')
	cfile.write('min_average_improvement = 0.05\n\n')
	cfile.write('if use_genetic_algorithm:\n')
	cfile.write('	population_size = 100\n')
	cfile.write('	#ranges of neural network parameters for the genetic algorithm to scan\n')
...
if __name__=="__main__":
    ...
    destiny = os.path.abspath('/user/llambrec/deepLearning')
    ### set input parameters
    indirs = []
    indirs.append(os.path.abspath('/user/llambrec/Files/tzqid/2016MC/signalregion_3tight_flat'))
