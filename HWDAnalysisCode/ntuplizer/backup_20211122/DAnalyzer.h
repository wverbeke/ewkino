...
class DAnalyzer {
  ...
  private:
    ...
    // track separation variables
    double _DTwoTrackSeparationX[nDs_max];
    double _DTwoTrackSeparationY[nDs_max];
    double _DTwoTrackSeparationZ[nDs_max];
    double _DTrackVtxSeparationX[nDs_max];
    double _DTrackVtxSeparationY[nDs_max];
    double _DTrackVtxSeparationZ[nDs_max];
    // track variables
