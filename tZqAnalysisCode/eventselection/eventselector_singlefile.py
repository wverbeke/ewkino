################################################################
# Make an eventselector.cc submission script for a single file #
################################################################
import sys
import os
import glob
...
# do not use this script lightly as it can create files with different selections in the same folder...
...
output_directory = '/storage_mnt/storage/user/llambrec/Files/signalregion/2016MC'
...
with open(script_name,'w') as script:
    ...
    script.write('cd {}\n'.format(cwd))
    command = './eventselector {} {} {}'.format(input_file,output_directory,event_selection)
