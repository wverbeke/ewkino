...
if __name__=="__main__":
    ...
    # systematics to draw
    systematictags = ['electronScale','electronRes'] # empty list for all systematics in file
    ...
    if(len(sys.argv)==2 and sys.argv[1][-5:]=='.root'):
        ...
        lumi = None
        if '2016' in histfile: lumi = 36300
        elif '2017' in histfile: lumi = 41500
        elif '2018' in histfile: lumi = 59700
        #elif '1617' in histfile: lumi = 77400 # to check new value for updated 2016 lumi
        elif 'allyears' in histfile: lumi = 137600
        elif 'yearscombined' in histfile: lumi = 137600
