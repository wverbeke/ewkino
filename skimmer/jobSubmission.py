...
def initializeJobScript( script, cmssw_version = 'CMSSW_10_2_16_patch1' ):
...
def runCommandAsJob( command, script_name, wall_time = '24:00:00', num_threads = 1, high_memory = False, cmssw_version = 'CMSSW_10_2_16_patch1' ):
