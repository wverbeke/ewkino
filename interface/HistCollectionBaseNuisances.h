...
class HistCollectionBaseNuisances : public HistCollectionBase{
    ...
    public:
        HistCollectionBaseNuisances(const std::shared_ptr<HistInfo>&, const std::shared_ptr<Sample>&, const std::shared_ptr<Category>&, const std::shared_ptr< std::vector < std::string > >&, const bool includeSB = false);
        HistCollectionBaseNuisances(const std::string&, const std::shared_ptr<HistInfo>&, const std::shared_ptr<Sample>&, const std::shared_ptr<Category>&, const std::shared_ptr< std::vector < std::string > >&, const bool includeSB = false);
